    ...
    steps:
      ...
      - name: Orbit autonomous cycle
        ...
        env:
          ...
          ORBIT_TOKEN_ADMIN_ADDRESS: ${{ secrets.ORBIT_TOKEN_ADMIN_ADDRESS }}
          ORBIT_TREASURY_ADDRESS: ${{ secrets.ORBIT_TREASURY_ADDRESS }}
          ORBIT_OPERATOR_REVENUE_ADDRESS: ${{ secrets.ORBIT_OPERATOR_REVENUE_ADDRESS }}
          ORBIT_OPERATOR_REVENUE_BPS: ${{ secrets.ORBIT_OPERATOR_REVENUE_BPS }}
          ORBIT_BASE_RPC_URL: ${{ secrets.ORBIT_BASE_RPC_URL }}
          ORBIT_WALLET_PRIVATE_KEY: ${{ secrets.ORBIT_WALLET_PRIVATE_KEY }}
          ORBIT_AGENT_SIGNER: ${{ vars.ORBIT_AGENT_SIGNER }}
          ORBIT_ENABLE_TOKEN_LAUNCH: ${{ vars.ORBIT_ENABLE_TOKEN_LAUNCH }}
          ORBIT_ENABLE_REVENUE_CLAIMS: ${{ vars.ORBIT_ENABLE_REVENUE_CLAIMS }}
