...
/**
 * Summarize a single proof record into a human-readable object.
 */
function summarizeProof(proof) {
  ...
  // Count AI usage entries
  const aiUsageSteps = steps.filter((s) => s.accounting === "ai_usage" || s.usage);
...
/**
 * Summarize a proof into a compact human-readable string.
 */
 ...
 *
 * @param {Array} proofs - Array of { filePath, proof } objects
