...
**Architecture.**
- gitty lives in its own public GitHub repo, scaffolded via `npx @orbit-house/create-orbit-repo`
...
- Then blocks on S-GATE-1 punch list item #5 (npm publish of `@orbit-house/create-orbit-repo`, `@orbit-house/sdk`, `@orbit-house/verifier`).
