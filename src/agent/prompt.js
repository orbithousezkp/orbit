...
function buildSystemPrompt() {
  return [
    ...
    "Never spend treasury assets to wallets outside Orbit's treasury or configured operator revenue recipient without a public owner approval issue or PR first.",
